 ...
 * to end. Live state rides the existing per-pipeline WebSocket (job picked
 * out client-side); the job-detail endpoint adds what the socket does not
 * carry — the assigned runner's identity and heartbeat health. Left: step
 * timeline + streaming logs. Right: runner, container, masked environment,
 * job artifacts, and metrics. Desktop gets a resizable split; below `lg`
 * it stacks, and the two layouts are exclusive so xterm mounts once.
 */
        ...
        <div className="h-[72vh] min-h-[520px] overflow-hidden rounded border border-steel/20 bg-canvas">
          <Group orientation="horizontal" className="h-full">
            <Panel defaultSize="58%" minSize="35%" className="flex flex-col">
              <div className="max-h-[45%] overflow-y-auto border-b border-steel/10 p-3">
